...
const CoinPage = () => {
  ...
  if (coin.tickers) {
    // Assuming coin.tickers is an array
    const binanceTicker = coin.tickers.find(
      (ticker) => ticker.market.name === "Binance"
    );

    trust_score = binanceTicker ? binanceTicker.trust_score : null;
  }
  ...
  return (
    <div className="rounded-div my-12 py-8">
        ...
        <div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              ...
              {trust_score && (
                <p className={`text-${trust_score.toLowerCase()} font-bold`}>
                  {trust_score.toUpperCase()}
                </p>      
              )}
            </div>
          </div>
      ...
      <div className="py-4">
        ...
        ></p> <br />
        <p>*Trust Score is generated by Binance*</p>
      </div>
    </div>
  );
};
